import time
try: from rpi_ws281x import *
except : print("Failed to import rpi_ws281x. Could be runnning in emulation mode.")
...
class LED:
    ...
    LED_PIN        = 12      #M GPIO pin connected to the pixels (18 uses PW!).
    ...
    def __init__(self):
        ...
        self.strip = Adafruit_NeoPixel(LED.LED_COUNT, LED.LED_PIN, LED.LED_FREQ_HZ, LED.LED_DMA, LED.LED_INVERT, LED.LED_BRIGHTNESS, LED.LED_CHANNEL)
    ...
    def theaterChase(self,strip, color, wait_ms=50, iterations=10):
        ...
        print(f"LEDs {strip} now in theater chase mode with color {color}")
        ...
        print("LEDs have stopped theater chase mode.")
    ...
    def rainbow(self,strip, wait_ms=20, iterations=1):
        ...
        print(f"LED {strip} now in rainbow mode.")
        ...
        print(f"LED {strip} ending rainbow mode.")
    ...
    def theaterChaseRainbow(self,strip, wait_ms=50):
        ...
        print(f"LED {strip} now in theater chase rainbow mode.")
        ...
        print(f"LED {strip} ending theater chase rainbow mode.")
